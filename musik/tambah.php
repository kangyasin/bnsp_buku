			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="card">
						...
						<h4 class="card-title">Tambah Lagu</h4>
						</div>
						<div class="card-body">
							<form action="../proses/crud.php?aksi=tambah_lagu" method="POST">
								<div class="form-group">
									<label>Judul Lagu </label>
									<input type="text" value="" class="form-control" name="judul_lagu">
								</div>
								<div class="form-group">
									<label>Penyanyi</label>
									<input type="text" value="" class="form-control" name="penyanyi">
								</div>
                <div class="form-group">
                  ...
                  <input type="text" value="" class="form-control" name="kategori">
								...
								<div class="form-group">
									<label>Tahun</label>
									<input type="number" value="" class="form-control" name="tahun">
								</div>
